...
If you allow the attribute style, the value will be processed by [cssfilter](./cssfilter) module. The cssfilter module includes a default css whitelist. You can specify the options for cssfilter module like this:
